    ...
    public:
        class Node {
            public:
                ...
                void rotate_left_left(Node *&to_this);
                void rotate_left_right(Node *&to_this);
                void rotate_right_right(Node *&to_this);
                void rotate_right_left(Node *&to_this);
...
bool Search_tree<Type>::Node::insert(Type const &obj, Search_tree<Type>::Node *&to_this) {
    if (obj < node_value) {
        if (left_tree == nullptr) {
            ...
            // update linear-order-related member variables
            ...
            if (left_tree->insert(obj, left_tree)) {
                ...
                if (left_tree->height() - right_tree->height() >= 2) {
                    ...
                    if (obj < left_tree -> node_value)
                        rotate_left_left(to_this);
                        // left-right rotate
                    else
                        rotate_left_right(to_this);
                }
            ...
            if (right_tree->insert(obj, right_tree)) {
                ...
                if (right_tree->height() - left_tree->height() >= 2) {
                    ...
                    if (obj > right_tree -> node_value)
                        rotate_right_right(to_this);
                        // left-right rotate
                    else
                        rotate_right_left(to_this);
                }
...
template<typename Type>
void Search_tree<Type>::Node::rotate_left_left(Node *&to_this) {
    Node* A = to_this;
    Node * B = A->left_tree;
...
template<typename Type>
void Search_tree<Type>::Node::rotate_left_right(Node *&to_this) {
    Node* A = to_this;
    Node* B = A->left_tree;
    Node* C = B->right_tree;
    A->left_tree = C->right_tree;
    B->right_tree = C->left_tree;
    C->left_tree = B;
    C->right_tree = A;
    A->update_height();
    B->update_height();
...
template<typename Type>
void Search_tree<Type>::Node::rotate_right_right(Node *&to_this) {
    Node* A = to_this;
    Node * B = A->right_tree;
...
template<typename Type>
void Search_tree<Type>::Node::rotate_right_left( Node *&to_this) {
    Node* A = to_this;
    Node* B = A->right_tree;
    Node* C = B->left_tree;
    A->right_tree = C->left_tree;
    B->left_tree = C->right_tree;
    C->right_tree = B;
    C->left_tree = A;
    A->update_height();
    B->update_height();
